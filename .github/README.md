...
[`@aws-sdk/client-lex-models-v2`](https://www.npmjs.com/package/@aws-sdk/client-lex-models-v2/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-models-v2@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-io+IDKjTUEGVM85fvHBXi3sRrgOVH3YcdCL9a7STdnAjZUxrW8mHtSuxzepIph5r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lex-models-v2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-models-v2@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-models-v2@3.919.0/index.min.mjs": "sha384-io+IDKjTUEGVM85fvHBXi3sRrgOVH3YcdCL9a7STdnAjZUxrW8mHtSuxzepIph5r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lex-models-v2/blob/refs/tags/3.919.0/LICENSE
```
