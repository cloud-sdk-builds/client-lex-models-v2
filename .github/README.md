...
[`@aws-sdk/client-lex-models-v2`](https://www.npmjs.com/package/@aws-sdk/client-lex-models-v2/v/3.1100.0).
...
- @aws-sdk/client-lex-models-v2 - [https://cloud-sdk-builds.github.io/?sdk=client-lex-models-v2](https://cloud-sdk-builds.github.io/?sdk=client-lex-models-v2)
- @aws-sdk/client-lex-models-v2 v3.1100.0 - [https://cloud-sdk-builds.github.io/?sdk=client-lex-models-v2&version=3.1100.0](https://cloud-sdk-builds.github.io/?sdk=client-lex-models-v2&version=3.1100.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-models-v2@3.1100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EENrlIUeIbrxVv4tNVZ6LEfJCEcZUQZTLSu/xpPUM2/RVL/MWlSqMC7QuvGa1crW
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-models-v2/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lex-models-v2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-models-v2@3.1100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-models-v2@3.1100.0/index.min.mjs": "sha384-EENrlIUeIbrxVv4tNVZ6LEfJCEcZUQZTLSu/xpPUM2/RVL/MWlSqMC7QuvGa1crW"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-lex-models-v2";
...
```
https://github.com/cloud-sdk-builds/client-lex-models-v2/blob/refs/tags/3.1100.0/LICENSE
```
